  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text("MacBook", style: GoogleFonts.roboto()),
                        ...
                        child: InkWell(
                          child: GestureDetector(
                            ...
                            child: Image(
                              image: ResizeImage(
                                AssetImage(
                                  "assets/images/mac/15inch2017.png",
                                ),
                                width: 600,
                                height: 600,
                              ),
                        ...
                        child: InkWell(
                          child: GestureDetector(
                            ...
                            child: Image(
                              image: ResizeImage(
                                AssetImage(
                                  "assets/images/mac/13inch_m1_2020.png",
                                ),
                                width: 600,
                                height: 600,
                              ),
                        ...
                        child: InkWell(
                          child: GestureDetector(
                            ...
                            child: Image(
                              image: ResizeImage(
                                AssetImage(
                                  "assets/images/mac/13inch2014.png",
                                ),
                                width: 600,
                                height: 600,
                              ),
                ...
                Expanded(
                  child: Column(
                    children: [
                        ...
                        child: InkWell(
                          child: GestureDetector(
                            ...
                            child: Image(
                              image: ResizeImage(
                                AssetImage(
                                  "assets/images/mac/12inch_2015.png",
                                ),
                                width: 600,
                                height: 600,
                              ),
                      ...
                      SizedBox(height: 10),
                      Text(
                        "Macbook 12 Inch 2015 Model A1534",
                        style: TextStyle(fontWeight: FontWeight.bold),
                      ),
                      SizedBox(height: 20)
                    ],
