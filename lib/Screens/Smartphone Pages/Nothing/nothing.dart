...
import 'package:flutter_application_2/Screens/Smartphone%20Pages/Nothing/nothingskin.dart';
...
class nothingphone extends StatefulWidget {
  const nothingphone({super.key});

  @override
  State<nothingphone> createState() => _nothingphoneState();
}

class _nothingphoneState extends State<nothingphone> {
  @override
                          ...
                          child: GestureDetector(
                            onTap: () {
                              Navigator.of(context).push(MaterialPageRoute(
                                builder: (context) => nothingskin(),
                              ));
                            },
                            child: Image(
                              image: ResizeImage(
                                AssetImage(
                                  "assets/images/nothing phone1.png",
                                ),
                                width: 600,
                                height: 600,
                              ),
