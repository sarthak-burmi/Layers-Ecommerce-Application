...
import 'package:flutter_application_2/Screens/Smartphone%20Pages/Nothing/nothing.dart';
...
//import 'package:flutter_application_2/Screens/cart_model.dart';
...
class nothingskin extends StatefulWidget {
  const nothingskin({super.key});

  @override
  State<nothingskin> createState() => _nothingskinState();
}

class _nothingskinState extends State<nothingskin>
    with TickerProviderStateMixin {
  bool isSelected = false;
  late nothingskins selectedSkin;
  late nothingskins withoutskin;

  final List<nothingskins> skins = [
    nothingskins(
      name: 'Nothing Phone 1',
      image: 'assets/images/nothing phone1.png',
      amount: 0,
    ),
    nothingskins(
        name: 'Nothing Phone 1 Astro Rainbow',
        image: 'assets/images/Nothing/Nothingsk1.png',
        amount: 449),
    nothingskins(
        name: 'Nothing Phone 1 Empowher',
        image: 'assets/images/Nothing/Nothingsk2.png',
        amount: 499),
    nothingskins(
        name: 'Nothing Phone 1 Florescence',
        image: 'assets/images/Nothing/Nothingsk3.png',
        amount: 599),
    nothingskins(
        name: 'Nothing Phone 1 Spaceboy',
        image: 'assets/images/Nothing/Nothingsk4.png',
        amount: 399),
    nothingskins(
        name: 'Nothing Phone 1 Iron Man For Duty',
        image: 'assets/images/Nothing/Nothingsk5.png',
        amount: 599),
  ];
  ...
  void _onSkinSelected(nothingskins skin) {
    setState(() {
      selectedSkin = skin;
    });
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text("Nothing", style: GoogleFonts.roboto()),
