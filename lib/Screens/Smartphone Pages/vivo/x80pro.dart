...
class x80pro extends StatefulWidget {
  const x80pro({super.key});

  @override
  State<x80pro> createState() => _x80proState();
}

class _x80proState extends State<x80pro> with TickerProviderStateMixin {
  ...
  final List<forteenpromaxskins> skins = [
    forteenpromaxskins(
      name: 'VIVO X80 Pro',
      image: 'assets/images/vivo/x80pro.png',
      amount: 0,
    ),
    forteenpromaxskins(
        name: 'VIVO X80 Pro Astro Rainbow',
        image: 'assets/images/vivo/x80psk1.png',
        amount: 449),
    forteenpromaxskins(
        name: 'VIVO X80 Pro Empowher',
        image: 'assets/images/vivo/x80psk2.png',
        amount: 499),
    forteenpromaxskins(
        name: 'VIVO X80 Pro Florescence',
        image: 'assets/images/vivo/x80psk3.png',
        amount: 599),
    forteenpromaxskins(
        name: 'VIVO X80 Pro Spaceboy',
        image: 'assets/images/vivo/x80psk4.png',
        amount: 399),
    forteenpromaxskins(
        name: 'VIVO X80 Pro Iron Man For Duty',
        image: 'assets/images/vivo/x80psk5.png',
        amount: 599),
  ];
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text("VIVO", style: GoogleFonts.roboto()),
