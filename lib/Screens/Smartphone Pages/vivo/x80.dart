...
class x80 extends StatefulWidget {
  const x80({super.key});

  @override
  State<x80> createState() => _x80State();
}

class _x80State extends State<x80> with TickerProviderStateMixin {
  ...
  final List<forteenpromaxskins> skins = [
    forteenpromaxskins(
      name: 'VIVO X80 ',
      image: 'assets/images/vivo/x80.png',
      amount: 0,
    ),
    forteenpromaxskins(
        name: 'VIVO X80 Astro Rainbow',
        image: 'assets/images/vivo/x80sk1.png',
        amount: 449),
    forteenpromaxskins(
        name: 'VIVO X80 Empowher',
        image: 'assets/images/vivo/x80sk2.png',
        amount: 499),
    forteenpromaxskins(
        name: 'VIVO X80 Florescence',
        image: 'assets/images/vivo/x80sk3.png',
        amount: 599),
    forteenpromaxskins(
        name: 'VIVO X80 Spaceboy',
        image: 'assets/images/vivo/x80sk4.png',
        amount: 399),
    forteenpromaxskins(
        name: 'VIVO X80 Iron Man For Duty',
        image: 'assets/images/vivo/x80sk5.png',
        amount: 599),
  ];
