...
class x70pro extends StatefulWidget {
  const x70pro({super.key});

  @override
  State<x70pro> createState() => _x70proState();
}

class _x70proState extends State<x70pro>
with TickerProviderStateMixin {
  ...
  final List<forteenpromaxskins> skins = [
    forteenpromaxskins(
      name: 'VIVO X70 Pro',
      image: 'assets/images/vivo/x70pro.png',
      amount: 0,
    ),
    forteenpromaxskins(
        name: 'VIVO X70 Pro Astro Rainbow',
        image: 'assets/images/vivo/x70sk1.png',
        amount: 449),
    forteenpromaxskins(
        name: 'VIVO X70 Pro Empowher',
        image: 'assets/images/vivo/x70sk2.png',
        amount: 499),
    forteenpromaxskins(
        name: 'VIVO X70 Pro Florescence',
        image: 'assets/images/vivo/x70sk3.png',
        amount: 599),
    forteenpromaxskins(
        name: 'VIVO X70 Pro Spaceboy',
        image: 'assets/images/vivo/x70sk4.png',
        amount: 399),
    forteenpromaxskins(
        name: 'VIVO X70 Pro Iron Man For Duty',
        image: 'assets/images/vivo/x70sk5.png',
        amount: 599),
  ];
