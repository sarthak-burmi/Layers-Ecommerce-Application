...
import 'package:flutter_application_2/Screens/Smartphone%20Pages/vivo/x50pro.dart';
import 'package:flutter_application_2/Screens/Smartphone%20Pages/vivo/x70pro.dart';
import 'package:flutter_application_2/Screens/Smartphone%20Pages/vivo/x80.dart';
import 'package:flutter_application_2/Screens/Smartphone%20Pages/vivo/x80pro.dart';
...
class vivophns extends StatelessWidget {
  vivophns({super.key});
                          ...
                          child: GestureDetector(
                            onTap: () {
                              Navigator.of(context).push(MaterialPageRoute(
                                builder: (context) => x80pro(),
                              ));
                            },
                            child: Image(
                              image: ResizeImage(
                                AssetImage(
                                  "assets/images/vivo/x80pro.png",
                                ),
                                width: 600,
                                height: 600,
                              ),
                      ...
                      Container(
                        ...
                        child: InkWell(
                          child: GestureDetector(
                            onTap: () {
                              Navigator.of(context).push(MaterialPageRoute(
                                builder: (context) => x70pro(),
                              ));
                            },
                            child: Image(
                              image: ResizeImage(
                                AssetImage(
                                  "assets/images/vivo/x70pro.png",
                                ),
                                width: 600,
                                height: 600,
                              ),
                      ...
                      Container(
                        ...
                        child: InkWell(
                          child: GestureDetector(
                            onTap: () {
                              Navigator.of(context).push(MaterialPageRoute(
                                builder: (context) => x50pro(),
                              ));
                            },
                            child: Image(
                              image: ResizeImage(
                                AssetImage(
                                  "assets/images/vivo/x50.png",
                                ),
                                width: 600,
                                height: 600,
                              ),
