...
class x50pro extends StatefulWidget {
  const x50pro({super.key});

  @override
  State<x50pro> createState() => _x50proState();
}

class _x50proState extends State<x50pro>
with TickerProviderStateMixin {
  ...
  final List<forteenpromaxskins> skins = [
    forteenpromaxskins(
      name: 'VIVO X50 Pro',
      image: 'assets/images/vivo/x50.png',
      amount: 0,
    ),
    forteenpromaxskins(
        name: 'VIVO X50 Pro Astro Rainbow',
        image: 'assets/images/vivo/x50sk1.png',
        amount: 449),
    forteenpromaxskins(
        name: 'VIVO X50 Pro Empowher',
        image: 'assets/images/vivo/x50sk2.png',
        amount: 499),
    forteenpromaxskins(
        name: 'VIVO X50 Pro Florescence',
        image: 'assets/images/vivo/x50sk3.png',
        amount: 599),
    forteenpromaxskins(
        name: 'VIVO X50 Pro Spaceboy',
        image: 'assets/images/vivo/x50sk4.png',
        amount: 399),
    forteenpromaxskins(
        name: 'VIVO X50 Pro Iron Man For Duty',
        image: 'assets/images/vivo/x50sk5.png',
        amount: 599),
  ];
