...
class iqoo9 extends StatefulWidget {
  const iqoo9({super.key});

  @override
  State<iqoo9> createState() => _iqoo9State();
}

class _iqoo9State extends State<iqoo9> with TickerProviderStateMixin {
  ...
  final List<forteenpromaxskins> skins = [
    forteenpromaxskins(
      name: 'Iqoo 9',
      image: 'assets/images/iqoo/iqoo9.png',
      amount: 0,
    ),
    forteenpromaxskins(
        name: 'Iqoo 9 Astro Rainbow',
        image: 'assets/images/iqoo/91.png',
        amount: 9),
    forteenpromaxskins(
        name: 'Iqoo 9 Empowher',
        image: 'assets/images/iqoo/92.png',
        amount: 499),
    forteenpromaxskins(
        name: 'Iqoo 9 Florescence',
        image: 'assets/images/iqoo/93.png',
        amount: 599),
    forteenpromaxskins(
        name: 'Iqoo 9 Spaceboy',
        image: 'assets/images/iqoo/94.png',
        amount: 399),
    forteenpromaxskins(
        name: 'Iqoo 9 Black Crack',
        image: 'assets/images/iqoo/95.png',
        amount: 599),
  ];
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: GestureDetector(
                      child: CircleAvatar(
                        backgroundImage:
                            AssetImage("assets/images/iqoo/neo6new.png"),
                      ),
                      onTap: () {
                        setState(() {
