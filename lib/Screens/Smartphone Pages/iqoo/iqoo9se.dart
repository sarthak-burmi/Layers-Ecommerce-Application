...
class iqoo9se extends StatefulWidget {
  const iqoo9se({super.key});

  @override
  State<iqoo9se> createState() => _iqoo9seState();
}

class _iqoo9seState extends State<iqoo9se> with TickerProviderStateMixin {
  ...
  final List<forteenpromaxskins> skins = [
    forteenpromaxskins(
      name: 'Iqoo 9 SE',
      image: 'assets/images/iqoo/IQOO9se.png',
      amount: 0,
    ),
    forteenpromaxskins(
        name: 'Iqoo 9 SE Astro Rainbow',
        image: 'assets/images/iqoo/9se1.png',
        amount: 449),
    forteenpromaxskins(
        name: 'Iqoo 9 SE Empowher',
        image: 'assets/images/iqoo/9se2.png',
        amount: 499),
    forteenpromaxskins(
        name: 'Iqoo 9 SE Florescence',
        image: 'assets/images/iqoo/9se3.png',
        amount: 599),
    forteenpromaxskins(
        name: 'Iqoo 9 SE Spaceboy',
        image: 'assets/images/iqoo/9se4.png',
        amount: 399),
    forteenpromaxskins(
        name: 'Iqoo 9 SE Iron Man For Duty',
        image: 'assets/images/iqoo/9se5.png',
        amount: 599),
  ];
