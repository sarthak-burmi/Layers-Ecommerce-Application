...
class iqoo7 extends StatefulWidget {
  const iqoo7({super.key});

  @override
  State<iqoo7> createState() => _iqoo7State();
}

class _iqoo7State extends State<iqoo7> with TickerProviderStateMixin {
  ...
  final List<forteenpromaxskins> skins = [
    forteenpromaxskins(
      name: 'Iqoo 7 5G',
      image: 'assets/images/iqoo/iqoo7.png',
      amount: 0,
    ),
    forteenpromaxskins(
        name: 'Iqoo 7 5G Astro Rainbow',
        image: 'assets/images/iqoo/iqoo7sk1.png',
        amount: 449),
    forteenpromaxskins(
        name: 'Iqoo 7 5G Empowher',
        image: 'assets/images/iqoo/iqoo7sk2.png',
        amount: 499),
    forteenpromaxskins(
        name: 'Iqoo 7 5G Florescence',
        image: 'assets/images/iqoo/iqoo7sk3.png',
        amount: 599),
    forteenpromaxskins(
        name: 'Iqoo 7 5G Spaceboy',
        image: 'assets/images/iqoo/iqoo7sk4.png',
        amount: 399),
    forteenpromaxskins(
        name: 'Iqoo 7 5G Iron Man For Duty',
        image: 'assets/images/iqoo/iqoo7sk5.png',
        amount: 599),
  ];
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text("IQOO", style: GoogleFonts.roboto()),
