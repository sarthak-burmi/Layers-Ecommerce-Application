...
import 'iqoo Neo 6.dart';
import 'iqoo7.dart';
import 'iqoo9.dart';
import 'iqoo9se.dart';

class iqoophonelist extends StatelessWidget {
  iqoophonelist({super.key});
                          ...
                          child: GestureDetector(
                            onTap: () {
                              Navigator.of(context).push(MaterialPageRoute(
                                builder: (context) => iqoo(),
                              ));
                            },
                            child: Image(
                              image: ResizeImage(
                                AssetImage(
                                  "assets/images/iqoo/iqooneo6.png",
                                ),
                                width: 600,
                                height: 600,
                              ),
                      ...
                      Container(
                        ...
                        child: InkWell(
                          child: GestureDetector(
                            onTap: () {
                              Navigator.of(context).push(MaterialPageRoute(
                                builder: (context) => iqoo7(),
                              ));
                            },
                            child: Image(
                              image: ResizeImage(
                                AssetImage(
                                  "assets/images/iqoo/iqoo7.png",
                                ),
                                width: 600,
                                height: 600,
                              ),
                      ...
                      Container(
                        ...
                        child: InkWell(
                          child: GestureDetector(
                            onTap: () {
                              Navigator.of(context).push(MaterialPageRoute(
                                builder: (context) => iqoo9(),
                              ));
                            },
                            child: Image(
                              image: ResizeImage(
                                AssetImage(
                                  "assets/images/iqoo/iqoo9.png",
                                ),
                                width: 600,
                                height: 600,
                              ),
                      ...
                      Container(
                        ...
                        child: InkWell(
                          child: GestureDetector(
                            onTap: () {
                              Navigator.of(context).push(MaterialPageRoute(
                                builder: (context) => iqoo9se(),
                              ));
                            },
                            child: Image(
                              image: ResizeImage(
                                AssetImage(
                                  "assets/images/iqoo/IQOO9se.png",
                                ),
                                width: 600,
                                height: 600,
                              ),
