...
class note11proplus extends StatefulWidget {
  const note11proplus({super.key});

  @override
  State<note11proplus> createState() => _note11proplusState();
}

class _note11proplusState extends State<note11proplus>
  ...
  final List<forteenpromaxskins> skins = [
    forteenpromaxskins(
      ...
      image: 'assets/images/redmi/11proplus.png',
      amount: 0,
    ),
    forteenpromaxskins(
        name: 'Redmi Note 11 Pro Plus Astro Rainbow',
        image: 'assets/images/redmi/note11sk1.png',
        amount: 449),
    forteenpromaxskins(
        name: 'Redmi Note 11 Pro Plus Empowher',
        image: 'assets/images/redmi/note11sk2.png',
        amount: 499),
    forteenpromaxskins(
        name: 'Redmi Note 11 Pro Plus Florescence',
        image: 'assets/images/redmi/note11sk3.png',
        amount: 599),
    forteenpromaxskins(
        name: 'Redmi Note 11 Pro Plus Spaceboy',
        image: 'assets/images/redmi/note11sk4.png',
        amount: 399),
    forteenpromaxskins(
        name: 'Redmi Note 11 Pro Plus Iron Man For Duty',
        image: 'assets/images/redmi/note11sk5.png',
        amount: 599),
  ];
