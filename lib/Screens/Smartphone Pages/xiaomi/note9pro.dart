...
class note9pro extends StatefulWidget {
  const note9pro({super.key});

  @override
  State<note9pro> createState() => _note9proState();
}

class _note9proState extends State<note9pro> with TickerProviderStateMixin {
  ...
  final List<forteenpromaxskins> skins = [
    forteenpromaxskins(
      ...
      image: 'assets/images/redmi/9pro.png',
      amount: 0,
    ),
    forteenpromaxskins(
        name: 'Redmi Note 9 Pro Astro Rainbow',
        image: 'assets/images/redmi/note9sk1.png',
        amount: 449),
    forteenpromaxskins(
        name: 'Redmi Note 9 Pro Empowher',
        image: 'assets/images/redmi/note9sk2.png',
        amount: 499),
    forteenpromaxskins(
        name: 'Redmi Note 9 Pro Florescence',
        image: 'assets/images/redmi/note9sk3.png',
        amount: 599),
    forteenpromaxskins(
        name: 'Redmi Note 9 Pro Spaceboy',
        image: 'assets/images/redmi/note9sk4.png',
        amount: 399),
    forteenpromaxskins(
        name: 'Redmi Note 9 Pro Iron Man For Duty',
        image: 'assets/images/redmi/note9sk5.png',
        amount: 599),
  ];
