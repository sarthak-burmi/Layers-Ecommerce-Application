...
class note8pro extends StatefulWidget {
  const note8pro({super.key});

  @override
  State<note8pro> createState() => _note8proState();
}

class _note8proState extends State<note8pro> with TickerProviderStateMixin {
  ...
  final List<forteenpromaxskins> skins = [
    forteenpromaxskins(
      ...
      image: 'assets/images/redmi/8pro.png',
      amount: 0,
    ),
    forteenpromaxskins(
        name: 'Redmi Note 8 Pro Astro Rainbow',
        image: 'assets/images/redmi/note8sk1.png',
        amount: 449),
    forteenpromaxskins(
        name: 'Redmi Note 8 Pro Empowher',
        image: 'assets/images/redmi/note8sk2.png',
        amount: 499),
    forteenpromaxskins(
        name: 'Redmi Note 8 Pro Florescence',
        image: 'assets/images/redmi/note8sk3.png',
        amount: 599),
    forteenpromaxskins(
        name: 'Redmi Note 8 Pro Spaceboy',
        image: 'assets/images/redmi/note8sk4.png',
        amount: 399),
    forteenpromaxskins(
        name: 'Redmi Note 8 Pro Iron Man For Duty',
        image: 'assets/images/redmi/note8sk5.png',
        amount: 599),
  ];
