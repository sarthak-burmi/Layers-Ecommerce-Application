...
class note10promax extends StatefulWidget {
  const note10promax({super.key});

  @override
  State<note10promax> createState() => _note10promaxState();
}

class _note10promaxState extends State<note10promax>
  ...
  final List<forteenpromaxskins> skins = [
    forteenpromaxskins(
      ...
      image: 'assets/images/redmi/10promax.png',
      amount: 0,
    ),
    forteenpromaxskins(
        name: 'Redmi 10 Pro Max Astro Rainbow',
        image: 'assets/images/redmi/note10sk1.png',
        amount: 449),
    forteenpromaxskins(
        name: 'Redmi 10 Pro Max Empowher',
        image: 'assets/images/redmi/note10sk2.png',
        amount: 499),
    forteenpromaxskins(
        name: 'Redmi 10 Pro Max Florescence',
        image: 'assets/images/redmi/note10sk3.png',
        amount: 599),
    forteenpromaxskins(
        name: 'Redmi 10 Pro Max Spaceboy',
        image: 'assets/images/redmi/note10sk4.png',
        amount: 399),
    forteenpromaxskins(
        name: 'Redmi 10 Pro Max Iron Man For Duty',
        image: 'assets/images/redmi/note10sk5.png',
        amount: 599),
  ];
