...
class s23plus extends StatefulWidget {
  const s23plus({super.key});

  @override
  State<s23plus> createState() => _s23plusState();
}

class _s23plusState extends State<s23plus> with TickerProviderStateMixin {
  ...
  final List<s23ultraskins> skins = [
    s23ultraskins(
      ...
      image: 'assets/images/samsung 23.png',
      amount: 000,
    ),
    s23ultraskins(
        name: 'Samsung S23 Plus Astro Rainbow',
        image: 'assets/images/s23pskin1.png',
        amount: 999),
    s23ultraskins(
        name: 'Samsung S23 Plus Empowher',
        image: 'assets/images/s23pskin2.png',
        amount: 1499),
    s23ultraskins(
        name: 'Samsung S23 Plus Florescence',
        image: 'assets/images/s23pskin3.png',
        amount: 1999),
    s23ultraskins(
        name: 'Samsung S23 Plus Spaceboy',
        image: 'assets/images/s23pskin4.png',
        amount: 1999),
    s23ultraskins(
        name: 'Samsung S23 Plus Iron Man For Duty',
        image: 'assets/images/s23pskin5.png',
        amount: 599),
  ];
