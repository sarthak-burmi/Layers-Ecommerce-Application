                          ...
                          child: GestureDetector(
                            onTap: () {
                              Navigator.of(context).push(MaterialPageRoute(
                                builder: (context) => samsungs23ultra(),
                              ));
                            },
                            child: Image(
                              image: ResizeImage(
                                AssetImage(
                                  "assets/images/s23 ultra.png",
                                ),
                                width: 600,
                                height: 600,
                              ),
                      ...
                      Container(
                        ...
                        child: InkWell(
                          child: GestureDetector(
                            onTap: () {
                              Navigator.of(context).push(MaterialPageRoute(
                                builder: (context) => s23plus(),
                              ));
                            },
                            child: Image(
                              image: ResizeImage(
                                AssetImage(
                                  "assets/images/samsung plus.png",
                                ),
                                width: 600,
                                height: 600,
                              ),
                      ...
                      Container(
                        ...
                        child: InkWell(
                          child: GestureDetector(
                            onTap: () {
                              Navigator.of(context).push(MaterialPageRoute(
                                builder: (context) => s22ultra(),
                              ));
                            },
                            child: Image(
                              image: ResizeImage(
                                AssetImage(
                                  "assets/images/S22 ultra.png",
                                ),
                                width: 600,
                                height: 600,
                              ),
                      ...
                      Container(
                        ...
                        child: InkWell(
                          child: GestureDetector(
                            onTap: () {
                              Navigator.of(context).push(MaterialPageRoute(
                                builder: (context) => s22plus(),
                              ));
                            },
                            child: Image(
                              image: ResizeImage(
                                AssetImage(
                                  "assets/images/S22plus.png",
                                ),
                                width: 600,
                                height: 600,
                              ),
                      ...
                      Container(
                        ...
                        child: InkWell(
                          child: GestureDetector(
                            onTap: () {
                              Navigator.of(context).push(MaterialPageRoute(
                                builder: (context) => s211ultra(),
                              ));
                            },
                            child: Image(
                              image: ResizeImage(
                                AssetImage(
                                  "assets/images/S21ultra.png",
                                ),
                                width: 600,
                                height: 600,
                              ),
                      ...
                      Container(
                        ...
                        child: InkWell(
                          child: GestureDetector(
                            onTap: () {
                              Navigator.of(context).push(MaterialPageRoute(
                                builder: (context) => s21fe(),
                              ));
                            },
                            child: Image(
                              image: ResizeImage(
                                AssetImage(
                                  "assets/images/s21fe.png",
                                ),
                                width: 600,
                                height: 600,
                              ),
