...
class s22plus extends StatefulWidget {
  const s22plus({super.key});

  @override
  State<s22plus> createState() => _s22plusState();
}

class _s22plusState extends State<s22plus> with TickerProviderStateMixin {
  ...
  final List<s23ultraskins> skins = [
    s23ultraskins(
      ...
      image: 'assets/images/S22plus.png',
      amount: 000,
    ),
    s23ultraskins(
        name: 'Samsung S22 Plus Astro Rainbow',
        image: 'assets/images/s22skin1.png',
        amount: 999),
    s23ultraskins(
        name: 'Samsung S22 Plus Empowher',
        image: 'assets/images/s22skin2.png',
        amount: 1499),
    s23ultraskins(
        name: 'Samsung S22 Plus Florescence',
        image: 'assets/images/s22skin3.png',
        amount: 1999),
    s23ultraskins(
        name: 'Samsung S22 Plus Spaceboy',
        image: 'assets/images/s22skin4.png',
        amount: 1999),
    s23ultraskins(
        name: 'Samsung S22 Plus Iron Man For Duty',
        image: 'assets/images/s22skin5.png',
        amount: 599),
  ];
