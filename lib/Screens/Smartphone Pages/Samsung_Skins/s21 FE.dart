...
class s21fe extends StatefulWidget {
  const s21fe({super.key});

  @override
  State<s21fe> createState() => _s21feState();
}

class _s21feState extends State<s21fe> with TickerProviderStateMixin {
  ...
  final List<s23ultraskins> skins = [
    ...
    s23ultraskins(
        name: 'Samsung S21 FE Astro Rainbow',
        image: 'assets/images/feskin1.png',
        amount: 999),
    s23ultraskins(
        name: 'Samsung S21 FE Empowher',
        image: 'assets/images/feskin2.png',
        amount: 1499),
    s23ultraskins(
        name: 'Samsung S21 FE Florescence',
        image: 'assets/images/feskin3.png',
        amount: 1999),
    s23ultraskins(
        name: 'Samsung S21 FE Spaceboy',
        image: 'assets/images/feskin4.png',
        amount: 1999),
    s23ultraskins(
        name: 'Samsung S21 FE Iron Man For Duty',
        image: 'assets/images/feskin5.png',
        amount: 599),
  ];
