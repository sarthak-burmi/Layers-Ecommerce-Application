...
import 'package:flutter_application_2/Screens/Smartphone%20Pages/oppo/opporeno6pro.dart';
import 'package:flutter_application_2/Screens/Smartphone%20Pages/oppo/opporeno7.dart';
import 'package:flutter_application_2/Screens/Smartphone%20Pages/oppo/opporeno7pro.dart';
...
import 'opporeno6.dart';

class oppophns extends StatelessWidget {
  oppophns({super.key});
                          ...
                          child: GestureDetector(
                            onTap: () {
                              Navigator.of(context).push(MaterialPageRoute(
                                builder: (context) => opporeno6(),
                              ));
                            },
                            child: Image(
                              image: ResizeImage(
                                AssetImage(
                                  "assets/images/oppo/oppor6.png",
                                ),
                                width: 600,
                                height: 600,
                              ),
                      ...
                      Container(
                        ...
                        child: InkWell(
                          child: GestureDetector(
                            onTap: () {
                              Navigator.of(context).push(MaterialPageRoute(
                                builder: (context) => opporeno6pro(),
                              ));
                            },
                            child: Image(
                              image: ResizeImage(
                                AssetImage(
                                  "assets/images/oppo/oppor6pro.png",
                                ),
                                width: 600,
                                height: 600,
                              ),
                      ...
                      Container(
                        ...
                        child: InkWell(
                          child: GestureDetector(
                            onTap: () {
                              Navigator.of(context).push(MaterialPageRoute(
                                builder: (context) => opporeno7(),
                              ));
                            },
                            child: Image(
                              image: ResizeImage(
                                AssetImage(
                                  "assets/images/oppo/oppor7.png",
                                ),
                                width: 600,
                                height: 600,
                              ),
                      ...
                      Container(
                        ...
                        child: InkWell(
                          child: GestureDetector(
                            onTap: () {
                              Navigator.of(context).push(MaterialPageRoute(
                                builder: (context) => opporeno7pro(),
                              ));
                            },
                            child: Image(
                              image: ResizeImage(
                                AssetImage(
                                  "assets/images/oppo/oppor7pro.png",
                                ),
                                width: 600,
                                height: 600,
                              ),
