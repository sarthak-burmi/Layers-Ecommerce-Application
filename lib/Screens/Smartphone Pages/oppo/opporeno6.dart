...
class opporeno6 extends StatefulWidget {
  const opporeno6({super.key});

  @override
  State<opporeno6> createState() => _opporeno6State();
}

class _opporeno6State extends State<opporeno6> with TickerProviderStateMixin {
  ...
  final List<forteenpromaxskins> skins = [
    forteenpromaxskins(
      name: 'Oppo Reno 6',
      image: 'assets/images/oppo/oppor6.png',
      amount: 0,
    ),
    forteenpromaxskins(
        name: 'Oppo Reno 6 Astro Rainbow',
        image: 'assets/images/oppo/6sk1.png',
        amount: 449),
    forteenpromaxskins(
        name: 'Oppo Reno 6 Empowher',
        image: 'assets/images/oppo/6sk2.png',
        amount: 499),
    forteenpromaxskins(
        name: 'Oppo Reno 6 Florescence',
        image: 'assets/images/oppo/6sk3.png',
        amount: 599),
    forteenpromaxskins(
        name: 'Oppo Reno 6 Spaceboy',
        image: 'assets/images/oppo/6sk4.png',
        amount: 399),
    forteenpromaxskins(
        name: 'Oppo Reno 6 Iron Man For Duty',
        image: 'assets/images/oppo/6sk5.png',
        amount: 599),
  ];
