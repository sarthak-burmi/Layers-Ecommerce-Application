...
class opporeno7 extends StatefulWidget {
  const opporeno7({super.key});

  @override
  State<opporeno7> createState() => _opporeno7State();
}

class _opporeno7State extends State<opporeno7> with TickerProviderStateMixin {
  ...
  final List<forteenpromaxskins> skins = [
    forteenpromaxskins(
      name: 'Oppo Reno 7',
      image: 'assets/images/oppo/oppor7.png',
      amount: 0,
    ),
    forteenpromaxskins(
        name: 'Oppo Reno 7 Astro Rainbow',
        image: 'assets/images/oppo/7sk1.png',
        amount: 9),
    forteenpromaxskins(
        name: 'Oppo Reno 7 Empowher',
        image: 'assets/images/oppo/7sk2.png',
        amount: 499),
    forteenpromaxskins(
        name: 'Oppo Reno 7 Florescence',
        image: 'assets/images/oppo/7sk3.png',
        amount: 599),
    forteenpromaxskins(
        name: 'Oppo Reno 7 Spaceboy',
        image: 'assets/images/oppo/7sk4.png',
        amount: 399),
    forteenpromaxskins(
        name: 'Oppo Reno 7 Iron Man For Duty',
        image: 'assets/images/oppo/7sk5.png',
        amount: 599),
  ];
