...
class opporeno6pro extends StatefulWidget {
  const opporeno6pro({super.key});

  @override
  State<opporeno6pro> createState() => _opporeno6proState();
}

class _opporeno6proState extends State<opporeno6pro>
  ...
  final List<forteenpromaxskins> skins = [
    forteenpromaxskins(
      ...
      image: 'assets/images/oppo/oppor6pro.png',
      amount: 0,
    ),
    forteenpromaxskins(
        name: 'Oppo Reno 6 Pro Astro Rainbow',
        image: 'assets/images/oppo/6prosk1.png',
        amount: 449),
    forteenpromaxskins(
        name: 'Oppo Reno 6 Pro Empowher',
        image: 'assets/images/oppo/6prosk2.png',
        amount: 499),
    forteenpromaxskins(
        name: 'Oppo Reno 6 Pro Florescence',
        image: 'assets/images/oppo/6prosk3.png',
        amount: 599),
    forteenpromaxskins(
        name: 'Oppo Reno 6 Pro Spaceboy',
        image: 'assets/images/oppo/6prosk4.png',
        amount: 399),
    forteenpromaxskins(
        name: 'Oppo Reno 6 Pro Iron Man For Duty',
        image: 'assets/images/oppo/6prosk5.png',
        amount: 599),
  ];
