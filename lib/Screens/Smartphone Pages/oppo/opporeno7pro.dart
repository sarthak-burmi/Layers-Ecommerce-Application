...
class opporeno7pro extends StatefulWidget {
  const opporeno7pro({super.key});

  @override
  State<opporeno7pro> createState() => _opporeno7proState();
}

class _opporeno7proState extends State<opporeno7pro>
  ...
  final List<forteenpromaxskins> skins = [
    forteenpromaxskins(
      ...
      image: 'assets/images/oppo/oppor7pro.png',
      amount: 0,
    ),
    forteenpromaxskins(
        name: 'Oppo Reno 7 Pro Astro Rainbow',
        image: 'assets/images/oppo/7prosk1.png',
        amount: 9),
    forteenpromaxskins(
        name: 'Oppo Reno 7 Pro Empowher',
        image: 'assets/images/oppo/7prosk2.png',
        amount: 499),
    forteenpromaxskins(
        name: 'Oppo Reno 7 Pro Florescence',
        image: 'assets/images/oppo/7prosk3.png',
        amount: 599),
    forteenpromaxskins(
        name: 'Oppo Reno 7 Pro Spaceboy',
        image: 'assets/images/oppo/7prosk4.png',
        amount: 399),
    forteenpromaxskins(
        name: 'Oppo Reno 7 Pro Iron Man For Duty',
        image: 'assets/images/oppo/7prosk5.png',
        amount: 599),
  ];
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text("OPPO", style: GoogleFonts.roboto()),
