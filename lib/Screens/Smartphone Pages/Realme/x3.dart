...
class x3pro extends StatefulWidget {
  const x3pro({super.key});

  @override
  State<x3pro> createState() => _x3proState();
}

class _x3proState extends State<x3pro> with TickerProviderStateMixin {
  ...
  final List<forteenpromaxskins> skins = [
    forteenpromaxskins(
      name: 'Realme X3',
      image: 'assets/images/realme/x3.png',
      amount: 0,
    ),
    forteenpromaxskins(
        name: 'Realme X3 Astro Rainbow',
        image: 'assets/images/realme/x3sk1.png',
        amount: 449),
    forteenpromaxskins(
        name: 'Realme X3 Empowher',
        image: 'assets/images/realme/x3sk2.png',
        amount: 499),
    forteenpromaxskins(
        name: 'Realme X3 Florescence',
        image: 'assets/images/realme/x3sk3.png',
        amount: 599),
    forteenpromaxskins(
        name: 'Realme X3 Spaceboy',
        image: 'assets/images/realme/x3sk4.png',
        amount: 399),
    forteenpromaxskins(
        name: 'Realme X3 Iron Man For Duty',
        image: 'assets/images/realme/x3sk5.png',
        amount: 599),
  ];
