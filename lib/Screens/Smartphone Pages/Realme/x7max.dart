...
class x7max extends StatefulWidget {
  const x7max({super.key});

  @override
  State<x7max> createState() => _x7maxState();
}

class _x7maxState extends State<x7max> with TickerProviderStateMixin {
  ...
  final List<forteenpromaxskins> skins = [
    forteenpromaxskins(
      name: 'Realme X7 Max',
      image: 'assets/images/realme/x7max.png',
      amount: 0,
    ),
    forteenpromaxskins(
        name: 'Realme X7 Max Astro Rainbow',
        image: 'assets/images/realme/x7sk1.png',
        amount: 449),
    forteenpromaxskins(
        name: 'Realme X7 Max Empowher',
        image: 'assets/images/realme/x7sk2.png',
        amount: 499),
    forteenpromaxskins(
        name: 'Realme X7 Max Florescence',
        image: 'assets/images/realme/x7sk3.png',
        amount: 599),
    forteenpromaxskins(
        name: 'Realme X7 Max Spaceboy',
        image: 'assets/images/realme/x7sk4.png',
        amount: 399),
    forteenpromaxskins(
        name: 'Realme X7 Max Iron Man For Duty',
        image: 'assets/images/realme/x7sk5.png',
        amount: 599),
  ];
