...
class x2pro extends StatefulWidget {
  const x2pro({super.key});

  @override
  State<x2pro> createState() => _x2proState();
}

class _x2proState extends State<x2pro> with TickerProviderStateMixin {
  ...
  final List<forteenpromaxskins> skins = [
    forteenpromaxskins(
      name: 'Realme X2 Pro',
      image: 'assets/images/realme/x2pro.png',
      amount: 0,
    ),
    forteenpromaxskins(
        name: 'Realme X2 Pro Astro Rainbow',
        image: 'assets/images/realme/x2sk1.png',
        amount: 449),
    forteenpromaxskins(
        name: 'Realme X2 Pro Empowher',
        image: 'assets/images/realme/x2sk2.png',
        amount: 499),
    forteenpromaxskins(
        name: 'Realme X2 Pro Florescence',
        image: 'assets/images/realme/x2sk3.png',
        amount: 599),
    forteenpromaxskins(
        name: 'Realme X2 Pro Spaceboy',
        image: 'assets/images/realme/x2sk4.png',
        amount: 399),
    forteenpromaxskins(
        name: 'Realme X2 Pro Iron Man For Duty',
        image: 'assets/images/realme/x2sk5.png',
        amount: 599),
  ];
