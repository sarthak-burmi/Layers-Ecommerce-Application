...
class gtmasteredition extends StatefulWidget {
  const gtmasteredition({super.key});

  @override
  State<gtmasteredition> createState() => _gtmastereditionState();
}

class _gtmastereditionState extends State<gtmasteredition>
  ...
  final List<forteenpromaxskins> skins = [
    forteenpromaxskins(
      ...
      image: 'assets/images/realme/gtmaster.png',
      amount: 0,
    ),
    forteenpromaxskins(
        name: 'Realme Gt Master Edition Astro Rainbow',
        image: 'assets/images/realme/gtsk1.png',
        amount: 449),
    forteenpromaxskins(
        name: 'Realme Gt Master Edition Empowher',
        image: 'assets/images/realme/gtsk2.png',
        amount: 499),
    forteenpromaxskins(
        name: 'Realme Gt Master Edition Florescence',
        image: 'assets/images/realme/gtsk3.png',
        amount: 599),
    forteenpromaxskins(
        name: 'Realme Gt Master Edition Spaceboy',
        image: 'assets/images/realme/gtsk4.png',
        amount: 399),
    forteenpromaxskins(
        name: 'Realme Gt Master Edition Iron Man For Duty',
        image: 'assets/images/realme/gtsk5.png',
        amount: 599),
  ];
  ...
  void _onSkinSelected(forteenpromaxskins skin) {
    setState(() {
      selectedSkin = skin;
    });
  }
