...
class iphone13skinpage extends StatefulWidget {
  const iphone13skinpage({super.key});

  @override
  State<iphone13skinpage> createState() => _iphone13skinpageState();
}

class _iphone13skinpageState extends State<iphone13skinpage>
  ...
  final List<smartphoneskin> skins = [
    ...
    smartphoneskin(
        name: 'iPhone 13 Astro Rainbow',
        image: 'assets/images/14 skin1.png',
        amount: 999),
    smartphoneskin(
        name: 'iPhone 13 Empowher',
        image: 'assets/images/14 skin2.png',
        amount: 1499),
    smartphoneskin(
        name: 'iPhone 13 Florescence',
        image: 'assets/images/14 skin3.png',
        amount: 1999),
    smartphoneskin(
        name: 'iPhone 13 Spaceboy',
        image: 'assets/images/14 skin4.png',
        amount: 1999),
    smartphoneskin(
        name: 'iPhone 13 Iron Man For Duty',
