...
class iphone14skinpage extends StatefulWidget {
  const iphone14skinpage({super.key});

  @override
  State<iphone14skinpage> createState() => _iphone14skinpageState();
}

class _iphone14skinpageState extends State<iphone14skinpage>
  ...
  final List<smartphoneskin> skins = [
    ...
    smartphoneskin(
        name: 'iPhone 14 Astro Rainbow',
        image: 'assets/images/14 skin1.png',
        amount: 999),
    smartphoneskin(
        name: 'iPhone 14 Empowher',
        image: 'assets/images/14 skin2.png',
        amount: 1499),
    smartphoneskin(
        name: 'iPhone 14 Florescence',
        image: 'assets/images/14 skin3.png',
        amount: 1999),
    smartphoneskin(
        name: 'iPhone 14 Spaceboy',
        image: 'assets/images/14 skin4.png',
        amount: 1999),
    smartphoneskin(
        name: 'iPhone 14 Iron Man For Duty',
