...
class iphone13promaxskinpage extends StatefulWidget {
  @override
  __iphone13promaxskinpageState createState() =>
      __iphone13promaxskinpageState();
}

class __iphone13promaxskinpageState extends State<iphone13promaxskinpage>
  ...
  final List<Skin> _skins = [
    Skin(
        ...
        amount: 000),
    Skin(
        name: 'iPhone 13 Pro Max Astro Rainbow',
        image: 'assets/images/14 pro max skin1.png',
        amount: 9.99),
    Skin(
        name: 'iPhone 13 Pro Max Max Empowher',
        image: 'assets/images/14 pro max skin2.png',
        amount: 14.99),
    Skin(
        name: 'iPhone 13 Pro Max Max Florescence',
        image: 'assets/images/14 pro max skin3.png',
        amount: 19.99),
    Skin(
        name: 'iPhone 13 Pro Max Spaceboy',
        image: 'assets/images/14 pro max skin4.png',
        amount: 1999),
    Skin(
        name: 'iPhone 13 Pro Max Iron Man For Duty',
