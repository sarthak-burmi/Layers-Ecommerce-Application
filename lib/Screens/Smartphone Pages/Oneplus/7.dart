...
class sevenskinage extends StatefulWidget {
  const sevenskinage({super.key});

  @override
  State<sevenskinage> createState() => _sevenskinageState();
}

class _sevenskinageState extends State<sevenskinage>
    with TickerProviderStateMixin {
  bool isSelected = false;
  late sevenskins selectedSkin;
  late sevenskins withoutskin;

  final List<sevenskins> skins = [
    sevenskins(
  ...
  void _onSkinSelected(sevenskins skin) {
    setState(() {
      selectedSkin = skin;
    });
  }
