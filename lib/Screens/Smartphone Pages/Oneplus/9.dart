...
class nineskinpage extends StatefulWidget {
  const nineskinpage({super.key});

  @override
  State<nineskinpage> createState() => _nineskinpageState();
}

class _nineskinpageState extends State<nineskinpage>
    with TickerProviderStateMixin {
  bool isSelected = false;
  late nineskins selectedSkin;
  late nineskins withoutskin;

  final List<nineskins> skins = [
    nineskins(
      name: 'OnePlus 9',
      image: 'assets/images/oneplusAll/Oneplus9.png',
      amount: 0,
    ),
    nineskins(
        name: 'OnePlus 9 Astro Rainbow',
        image: 'assets/images/oneplusAll/9sk1.png',
        amount: 9),
    nineskins(
        name: 'OnePlus 9 Empowher',
        image: 'assets/images/oneplusAll/9sk2.png',
        amount: 499),
    nineskins(
        name: 'OnePlus 9 Florescence',
        image: 'assets/images/oneplusAll/9sk3.png',
        amount: 599),
    nineskins(
        name: 'OnePlus 9 Spaceboy',
        image: 'assets/images/oneplusAll/9sk4.png',
        amount: 399),
    nineskins(
        name: 'OnePlus 9 Iron Man For Duty',
        image: 'assets/images/oneplusAll/9sk5.png',
        amount: 599),
  ];
  ...
  void _onSkinSelected(nineskins skin) {
    setState(() {
      selectedSkin = skin;
    });
  }
