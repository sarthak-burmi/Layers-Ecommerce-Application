...
class sevenproskinpage extends StatefulWidget {
  const sevenproskinpage({super.key});

  @override
  State<sevenproskinpage> createState() => _sevenproskinpageState();
}

class _sevenproskinpageState extends State<sevenproskinpage>
    with TickerProviderStateMixin {
  bool isSelected = false;
  late sevenproskins selectedSkin;
  late sevenproskins withoutskin;

  final List<sevenproskins> skins = [
    sevenproskins(
  ...
  void _onSkinSelected(sevenproskins skin) {
    setState(() {
      selectedSkin = skin;
    });
  }
