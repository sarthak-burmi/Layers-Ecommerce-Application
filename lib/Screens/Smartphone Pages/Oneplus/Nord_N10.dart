...
class nordN10skinpage extends StatefulWidget {
  const nordN10skinpage({super.key});

  @override
  State<nordN10skinpage> createState() => _nordN10skinpageState();
}

class _nordN10skinpageState extends State<nordN10skinpage>
    with TickerProviderStateMixin {
  bool isSelected = false;
  late nordN10skins selectedSkin;
  late nordN10skins withoutskin;

  final List<nordN10skins> skins = [
    nordN10skins(
  ...
  void _onSkinSelected(nordN10skins skin) {
    setState(() {
      selectedSkin = skin;
    });
  }
