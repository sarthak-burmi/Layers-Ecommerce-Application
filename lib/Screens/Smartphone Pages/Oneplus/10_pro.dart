...
class tenproskinpage extends StatefulWidget {
  const tenproskinpage({super.key});

  @override
  State<tenproskinpage> createState() => _tenproskinpageState();
}

class _tenproskinpageState extends State<tenproskinpage>
    with TickerProviderStateMixin {
  bool isSelected = false;
  late tenproskins selectedSkin;
  late tenproskins withoutskin;

  final List<tenproskins> skins = [
    tenproskins(
      name: 'Oneplus 10 Pro',
      image: 'assets/images/oneplusAll/Oneplus10pro.png',
      amount: 0,
    ),
    tenproskins(
        name: 'Oneplus 10 Pro Astro Rainbow',
        image: 'assets/images/oneplusAll/10prosk1.png',
        amount: 9),
    tenproskins(
        name: 'Oneplus 10 Pro Empowher',
        image: 'assets/images/oneplusAll/10prosk2.png',
        amount: 499),
    tenproskins(
        name: 'Oneplus 10 Pro Florescence',
        image: 'assets/images/oneplusAll/10prosk3.png',
        amount: 599),
    tenproskins(
        name: 'Oneplus 10 Pro Spaceboy',
        image: 'assets/images/oneplusAll/10prosk4.png',
        amount: 399),
    tenproskins(
        name: 'Oneplus 10 Pro Iron Man For Duty',
        image: 'assets/images/oneplusAll/10prosk5.png',
        amount: 599),
  ];
  ...
  void _onSkinSelected(tenproskins skin) {
    setState(() {
      selectedSkin = skin;
    });
  }
