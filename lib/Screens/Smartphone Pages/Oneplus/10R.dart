...
class tenRskinpage extends StatefulWidget {
  const tenRskinpage({super.key});

  @override
  State<tenRskinpage> createState() => _tenRskinpageState();
}

class _tenRskinpageState extends State<tenRskinpage>
    with TickerProviderStateMixin {
  bool isSelected = false;
  late tenRskins selectedSkin;
  late tenRskins withoutskin;

  final List<tenRskins> skins = [
    tenRskins(
      name: 'OnePlus 10R',
      image: 'assets/images/oneplusAll/Oneplus10R.png',
      amount: 0,
    ),
    tenRskins(
        name: 'OnePlus 10R Astro Rainbow',
        image: 'assets/images/oneplusAll/10rsk1.png',
        amount: 9),
    tenRskins(
        name: 'OnePlus 10R Empowher',
        image: 'assets/images/oneplusAll/10rsk2.png',
        amount: 499),
    tenRskins(
        name: 'OnePlus 10R Florescence',
        image: 'assets/images/oneplusAll/10rsk3.png',
        amount: 599),
    tenRskins(
        name: 'OnePlus 10R Spaceboy',
        image: 'assets/images/oneplusAll/10rsk4.png',
        amount: 399),
    tenRskins(
        name: 'OnePlus 10R Iron Man For Duty',
        image: 'assets/images/oneplusAll/10rsk5.png',
        amount: 599),
  ];
  ...
  void _onSkinSelected(tenRskins skin) {
    setState(() {
      selectedSkin = skin;
    });
  }
