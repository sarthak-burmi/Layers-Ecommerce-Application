...
class nineproskinpage extends StatefulWidget {
  const nineproskinpage({super.key});

  @override
  State<nineproskinpage> createState() => _nineproskinpageState();
}

class _nineproskinpageState extends State<nineproskinpage>
    with TickerProviderStateMixin {
  bool isSelected = false;
  late nineproskins selectedSkin;
  late nineproskins withoutskin;

  final List<nineproskins> skins = [
    nineproskins(
      name: 'OnePlus 9 Pro ',
      image: 'assets/images/oneplusAll/Oneplus9pro.png',
      amount: 0,
    ),
    nineproskins(
        name: 'OnePlus 9 Pro Astro Rainbow',
        image: 'assets/images/oneplusAll/9prosk1.png',
        amount: 9),
    nineproskins(
        name: 'OnePlus 9 Pro Empowher',
        image: 'assets/images/oneplusAll/9prosk2.png',
        amount: 499),
    nineproskins(
        name: 'OnePlus 9 Pro Florescence',
        image: 'assets/images/oneplusAll/9prosk3.png',
        amount: 599),
    nineproskins(
        name: 'OnePlus 9 Pro Spaceboy',
        image: 'assets/images/oneplusAll/9prosk4.png',
        amount: 399),
    nineproskins(
        name: 'OnePlus 9 Pro Iron Man For Duty',
        image: 'assets/images/oneplusAll/9prosk5.png',
        amount: 599),
  ];
  ...
  void _onSkinSelected(nineproskins skin) {
    setState(() {
      selectedSkin = skin;
    });
  }
