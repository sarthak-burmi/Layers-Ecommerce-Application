...
class elevenskinpage extends StatefulWidget {
  const elevenskinpage({super.key});

  @override
  State<elevenskinpage> createState() => _elevenskinpageState();
}

class _elevenskinpageState extends State<elevenskinpage>
    with TickerProviderStateMixin {
  bool isSelected = false;
  late elevenskins selectedSkin;
  late elevenskins withoutskin;

  final List<elevenskins> skins = [
    elevenskins(
      name: 'OnePlus 11',
  ...
  void _onSkinSelected(elevenskins skin) {
    setState(() {
      selectedSkin = skin;
    });
  }
