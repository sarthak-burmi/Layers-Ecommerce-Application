...
class eightTskinpage extends StatefulWidget {
  const eightTskinpage({super.key});

  @override
  State<eightTskinpage> createState() => _eightTskinpageState();
}

class _eightTskinpageState extends State<eightTskinpage>
    with TickerProviderStateMixin {
  bool isSelected = false;
  late eightTskins selectedSkin;
  late eightTskins withoutskin;

  final List<eightTskins> skins = [
    eightTskins(
  ...
  void _onSkinSelected(eightTskins skin) {
    setState(() {
      selectedSkin = skin;
    });
  }
