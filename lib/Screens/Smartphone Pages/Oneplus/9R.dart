...
class nineRskinpage extends StatefulWidget {
  const nineRskinpage({super.key});

  @override
  State<nineRskinpage> createState() => _nineRskinpageState();
}

class _nineRskinpageState extends State<nineRskinpage>
    with TickerProviderStateMixin {
  bool isSelected = false;
  late nineRskins selectedSkin;
  late nineRskins withoutskin;

  final List<nineRskins> skins = [
    nineRskins(
      name: 'OnePlus 9R',
      image: 'assets/images/oneplusAll/Oneplus9R.png',
      amount: 0,
    ),
    nineRskins(
        name: 'OnePlus 9R Astro Rainbow',
        image: 'assets/images/oneplusAll/9rsk1.png',
        amount: 9),
    nineRskins(
        name: 'OnePlus 9R Empowher',
        image: 'assets/images/oneplusAll/9rsk2.png',
        amount: 499),
    nineRskins(
        name: 'OnePlus 9R Florescence',
        image: 'assets/images/oneplusAll/9rsk3.png',
        amount: 599),
    nineRskins(
        name: 'OnePlus 9R Spaceboy',
        image: 'assets/images/oneplusAll/9rsk4.png',
        amount: 399),
    nineRskins(
        name: 'OnePlus 9R Iron Man For Duty',
        image: 'assets/images/oneplusAll/9rsk5.png',
        amount: 599),
  ];
  ...
  void _onSkinSelected(nineRskins skin) {
    setState(() {
      selectedSkin = skin;
    });
  }
