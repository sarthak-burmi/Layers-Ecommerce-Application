...
class nord5Gskinpage extends StatefulWidget {
  const nord5Gskinpage({super.key});

  @override
  State<nord5Gskinpage> createState() => _nord5GskinpageState();
}

class _nord5GskinpageState extends State<nord5Gskinpage>
    with TickerProviderStateMixin {
  bool isSelected = false;
  late nord5Gskins selectedSkin;
  late nord5Gskins withoutskin;

  final List<nord5Gskins> skins = [
    nord5Gskins(
  ...
  void _onSkinSelected(nord5Gskins skin) {
    setState(() {
      selectedSkin = skin;
    });
  }
