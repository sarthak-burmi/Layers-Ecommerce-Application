...
class eightskinpage extends StatefulWidget {
  const eightskinpage({super.key});

  @override
  State<eightskinpage> createState() => _eightskinpageState();
}

class _eightskinpageState extends State<eightskinpage>
    with TickerProviderStateMixin {
  bool isSelected = false;
  late eightskins selectedSkin;
  late eightskins withoutskin;

  final List<eightskins> skins = [
    eightskins(
  ...
  void _onSkinSelected(eightskins skin) {
    setState(() {
      selectedSkin = skin;
    });
  }
