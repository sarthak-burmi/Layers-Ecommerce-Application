...
class nord25Gskinpage extends StatefulWidget {
  const nord25Gskinpage({super.key});

  @override
  State<nord25Gskinpage> createState() => _nord25GskinpageState();
}

class _nord25GskinpageState extends State<nord25Gskinpage>
    with TickerProviderStateMixin {
  bool isSelected = false;
  late nord25gskins selectedSkin;
  late nord25gskins withoutskin;

  final List<nord25gskins> skins = [
    nord25gskins(
    ...
    nord25gskins(
        name: 'OnePlus Nord 2 5G Astro Rainbow',
        image: 'assets/images/14 pro max skin1.png',
        amount: 9),
    nord25gskins(
        name: 'OnePlus Nord 2 5G Empowher',
        image: 'assets/images/14 pro max skin2.png',
        amount: 499),
    nord25gskins(
        name: 'OnePlus Nord 2 5G Florescence',
        image: 'assets/images/14 pro max skin3.png',
        amount: 599),
    nord25gskins(
        name: 'OnePlus Nord 2 5G Spaceboy',
        image: 'assets/images/14 pro max skin4.png',
        amount: 399),
    nord25gskins(
        name: 'OnePlus Nord 2 5G Iron Man For Duty',
  ...
  void _onSkinSelected(nord25gskins skin) {
    setState(() {
      selectedSkin = skin;
    });
  }
