...
class eightproskinpage extends StatefulWidget {
  const eightproskinpage({super.key});

  @override
  State<eightproskinpage> createState() => _eightproskinpageState();
}

class _eightproskinpageState extends State<eightproskinpage>
    with TickerProviderStateMixin {
  bool isSelected = false;
  late eightproskins selectedSkin;
  late eightproskins withoutskin;

  final List<eightproskins> skins = [
    eightproskins(
  ...
  void _onSkinSelected(eightproskins skin) {
    setState(() {
      selectedSkin = skin;
    });
  }
