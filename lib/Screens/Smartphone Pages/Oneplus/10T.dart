...
class tenTskinpage extends StatefulWidget {
  const tenTskinpage({super.key});

  @override
  State<tenTskinpage> createState() => _tenTskinpageState();
}

class _tenTskinpageState extends State<tenTskinpage>
    with TickerProviderStateMixin {
  bool isSelected = false;
  late tenTskins selectedSkin;
  late tenTskins withoutskin;

  final List<tenTskins> skins = [
    tenTskins(
      name: 'OnePlus 10T',
      image: 'assets/images/oneplusAll/Oneplus10T.png',
      amount: 0,
    ),
    tenTskins(
        name: 'OnePlus 10T Astro Rainbow',
        image: 'assets/images/oneplusAll/10tsk1.png',
        amount: 9),
    tenTskins(
        name: 'OnePlus 10T Empowher',
        image: 'assets/images/oneplusAll/10tsk2.png',
        amount: 499),
    tenTskins(
        name: 'OnePlus 10T Florescence',
        image: 'assets/images/oneplusAll/10tsk3.png',
        amount: 599),
    tenTskins(
        name: 'OnePlus 10T Spaceboy',
        image: 'assets/images/oneplusAll/10tsk4.png',
        amount: 399),
    tenTskins(
        name: 'OnePlus 10T Iron Man For Duty',
        image: 'assets/images/oneplusAll/10tsk5.png',
        amount: 599),
  ];
  ...
  void _onSkinSelected(tenTskins skin) {
    setState(() {
      selectedSkin = skin;
    });
  }
