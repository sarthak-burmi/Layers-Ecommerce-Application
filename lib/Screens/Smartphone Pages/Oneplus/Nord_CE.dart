...
class nordCEskinpage extends StatefulWidget {
  const nordCEskinpage({super.key});

  @override
  State<nordCEskinpage> createState() => _nordCEskinpageState();
}

class _nordCEskinpageState extends State<nordCEskinpage>
    with TickerProviderStateMixin {
  bool isSelected = false;
  late nordCEskins selectedSkin;
  late nordCEskins withoutskin;

  final List<nordCEskins> skins = [
    nordCEskins(
  ...
  void _onSkinSelected(nordCEskins skin) {
    setState(() {
      selectedSkin = skin;
    });
  }
