...
class sevenTskinpage extends StatefulWidget {
  const sevenTskinpage({super.key});

  @override
  State<sevenTskinpage> createState() => _sevenTskinpageState();
}

class _sevenTskinpageState extends State<sevenTskinpage>
    with TickerProviderStateMixin {
  bool isSelected = false;
  late sevenTskin selectedSkin;
  late sevenTskin withoutskin;

  final List<sevenTskin> skins = [
    sevenTskin(
  ...
  void _onSkinSelected(sevenTskin skin) {
    setState(() {
      selectedSkin = skin;
    });
  }
