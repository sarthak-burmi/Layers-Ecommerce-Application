...
class nineRTskinpage extends StatefulWidget {
  const nineRTskinpage({super.key});

  @override
  State<nineRTskinpage> createState() => _nineRTskinpageState();
}

class _nineRTskinpageState extends State<nineRTskinpage>
    with TickerProviderStateMixin {
  bool isSelected = false;
  late nineRTskins selectedSkin;
  late nineRTskins withoutskin;

  final List<nineRTskins> skins = [
    nineRTskins(
      name: 'OnePlus 9RT',
      image: 'assets/images/oneplusAll/Oneplus9RT.png',
      amount: 0,
    ),
    nineRTskins(
        name: 'OnePlus 9RT Astro Rainbow',
        image: 'assets/images/oneplusAll/9rtsk1.png',
        amount: 9),
    nineRTskins(
        name: 'OnePlus 9RT Empowher',
        image: 'assets/images/oneplusAll/9rtsk2.png',
        amount: 499),
    nineRTskins(
        name: 'OnePlus 9RT Florescence',
        image: 'assets/images/oneplusAll/9rtsk3.png',
        amount: 599),
    nineRTskins(
        name: 'OnePlus 9RT Spaceboy',
        image: 'assets/images/oneplusAll/9rtsk4.png',
        amount: 399),
    nineRTskins(
        name: 'OnePlus 9RT Iron Man For Duty',
        image: 'assets/images/oneplusAll/9rtsk5.png',
        amount: 599),
  ];
  ...
  void _onSkinSelected(nineRTskins skin) {
    setState(() {
      selectedSkin = skin;
    });
  }
