...
class elevenRskinpage extends StatefulWidget {
  const elevenRskinpage({super.key});

  @override
  State<elevenRskinpage> createState() => _elevenRskinpageState();
}

class _elevenRskinpageState extends State<elevenRskinpage>
    with TickerProviderStateMixin {
  bool isSelected = false;
  late elevenRskins selectedSkin;
  late elevenRskins withoutskin;

  final List<elevenRskins> skins = [
    elevenRskins(
      name: 'OnePlus 11R',
      image: 'assets/images/oneplusAll/Oneplus11R.png',
      amount: 0,
    ),
    elevenRskins(
        name: 'OnePlus 11R Astro Rainbow',
        image: 'assets/images/oneplusAll/11rSk1.png',
        amount: 9),
    elevenRskins(
        name: 'OnePlus 11R Max Empowher',
        image: 'assets/images/oneplusAll/11rSk2.png',
        amount: 499),
    elevenRskins(
        name: 'OnePlus 11R Florescence',
        image: 'assets/images/oneplusAll/11rSk3.png',
        amount: 599),
    elevenRskins(
        name: 'OnePlus 11R Spaceboy',
        image: 'assets/images/oneplusAll/11rSk4.png',
        amount: 399),
    elevenRskins(
        name: 'OnePlus 11R Iron Man For Duty',
        image: 'assets/images/oneplusAll/11rSkin5.png',
        amount: 599),
  ];
  ...
  void _onSkinSelected(elevenRskins skin) {
    setState(() {
      selectedSkin = skin;
    });
  }
